...
HD_PWD='C:/Xilinx_projects/Chipscope/project_yunkun/project_yunkun.runs/ila_yunkun_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_yunkun.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_yunkun.tcl
