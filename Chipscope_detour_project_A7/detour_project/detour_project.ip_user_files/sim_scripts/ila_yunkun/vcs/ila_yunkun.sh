...
#
# Script generated by Vivado on Thu Oct 24 12:55:11 -0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_yunkun.sh
...
#
# Usage        : ila_yunkun.sh
#                ila_yunkun.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_yunkun.sh [-reset_run]
#                ila_yunkun.sh [-reset_log]
#                ila_yunkun.sh [-help]
#
...
#                script (type 'ila_yunkun.sh -help' for more information).
#
...
# script info
echo -e "ila_yunkun.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_yunkun.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../project_yunkun.gen/sources_1/ip/ila_yunkun/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../project_yunkun.gen/sources_1/ip/ila_yunkun/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_yunkun xil_defaultlib.glbl -o ila_yunkun_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_yunkun_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_yunkun_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_yunkun_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_yunkun.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_yunkun.sh [-help]\n\
Usage: ila_yunkun.sh [-step]\n\
Usage: ila_yunkun.sh [-lib_map_path]\n\
Usage: ila_yunkun.sh [-reset_run]\n\
Usage: ila_yunkun.sh [-reset_log]\n\
Usage: ila_yunkun.sh [-keep_index]\n\
Usage: ila_yunkun.sh [-noclean_files]\n\n\
