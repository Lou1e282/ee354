...
HD_PWD='C:/Xilinx_projects/Divider_Pico_N4_4bit/synthesis/synthesis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divider_4_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divider_4_top.tcl
