...
HD_PWD='C:/Xilinx_projects/Divider_Pico_N4_4bit/synthesis/synthesis.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divider_4_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divider_4_top.tcl -notrace
